...
def plot_avg_failed_task():
    """
    Plot average failed tasks for different application types
    """
    ...
    # plot_generic_result(2, 2, 'Failed Tasks on Cloudlet (%)', 'ALL_APPS', 'percentage_for_all')
    # plot_generic_result(2, 2, ['Failed Tasks on Cloudlet', 'for Augmented Reality App (%)'], 'AUGMENTED_REALITY', 'percentage_for_all')
    # plot_generic_result(2, 2, 'Failed Tasks on Cloudlet for Health App (%)', 'HEALTH_APP', 'percentage_for_all')
    # plot_generic_result(2, 2, 'Failed Tasks on Cloudlet for Infotainment App (%)', 'INFOTAINMENT_APP', 'percentage_for_all')
    # plot_generic_result(2, 2, 'Failed Tasks on Cloudlet for Heavy Comp. App (%)', 'HEAVY_COMP_APP', 'percentage_for_all')
